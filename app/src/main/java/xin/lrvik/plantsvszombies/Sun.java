...
/**
 * Author by 豢涵, Email huanhanfu@126.com, Date on 2018/12/6.
 */
public class Sun extends CCSprite {
    ...
    public Sun() {
        ...
        for (int i = 0; i < 22; i++) {
            CCSpriteFrame ccSpriteFrame = CCSprite.sprite(String.format(Locale.CHINA, "sun/Frame%02d.png", i)).displayedFrame();
